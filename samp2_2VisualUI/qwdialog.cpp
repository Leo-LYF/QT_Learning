    ...
    ui(new Ui::QWDialog)
{
    ...
    connect(ui->rBtnBlack, SIGNAL(clicked(bool)), this, SLOT(setTextFontColor()));

    connect(ui->rBtnBlue, SIGNAL(clicked(bool)), this, SLOT(setTextFontColor()));

    connect(ui->rBtnRed, SIGNAL(clicked(bool)), this, SLOT(setTextFontColor()));
